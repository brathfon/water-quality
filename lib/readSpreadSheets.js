  ...
  lines.forEach( function (line) {
      ...
      if (lineCount > 3) {  // first three lines are header information
        ...
        if (pieces.length === 45) {
          ...
          console.error(`ERROR: unexpected number of column: ${pieces.length}. Expecting 44. In file ${filename}`);
          console.error(`ERROR: Line: ${line}`);
          console.log(`ERROR: unexpected number of column: ${pieces.length}. Expecting 44. In file ${filename}`);
