...
CREATE TABLE IF NOT EXISTS `samples` (
  ...
  `sampling_order` INT NULL DEFAULT NULL COMMENT 'This is the order of this sample at this site as planned for the day during this session',
  `the_time` TIME NULL,
  `moon` INT NULL,
