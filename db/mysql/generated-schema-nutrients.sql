...
CREATE TABLE IF NOT EXISTS `samples` (
  ...
  `temperature` FLOAT NULL DEFAULT NULL COMMENT 'Units: degrees C',
  `salinity` FLOAT NULL DEFAULT NULL COMMENT 'Units: ppt (parts per thousand)',
  `dissolved_oxygen` FLOAT NULL DEFAULT NULL COMMENT 'Units: mg/L (milligrams per liter)',
  `dissolved_oxygen_pct` FLOAT NULL DEFAULT NULL COMMENT 'This is the dissolved oxygen percent saturation. Units: %',
  `ph` FLOAT NULL DEFAULT NULL,
  `turbidity_1` FLOAT NULL DEFAULT NULL COMMENT 'Units: NTU (Nephelometric Turbidity Unit)',
  `turbidity_2` FLOAT NULL DEFAULT NULL,
  `turbidity_3` FLOAT NULL DEFAULT NULL,
  `total_nitrogen` FLOAT NULL DEFAULT NULL COMMENT 'Units: micrograms per liter',
  `total_phosphorus` FLOAT NULL DEFAULT NULL COMMENT 'Units: micrograms per liter',
  `phosphate` FLOAT NULL DEFAULT NULL COMMENT 'Units: micrograms per liter',
  `silicate` FLOAT NULL DEFAULT NULL,
  `nitrates` FLOAT NULL DEFAULT NULL COMMENT 'Units: micrograms per liter',
  `ammonia` FLOAT NULL DEFAULT NULL COMMENT 'Units: micrograms per liter',
  `nitrate_last_run_date` DATE NULL DEFAULT NULL,
  `comments` VARCHAR(256) NULL DEFAULT NULL COMMENT 'Date of the last, or oldest, processing run of the nitrate testing.',
