...
CREATE TABLE IF NOT EXISTS `logs` (
  ...
  `user` VARCHAR(65) NOT NULL COMMENT 'who was logged in and using the app',
  ...
  `json_text` VARCHAR(512) NULL COMMENT 'array of strings to further describe the longed information',
  PRIMARY KEY (`log_id`))
ENGINE = InnoDB;
