...
mysql -v -u $user -p$pw $db < ../xfer/insert-data-sessions-1-77w-1-52s.0.sql
mysql -v -u $user -p$pw $db < ../xfer/update-nutrient-data.20201014.0.nutrient-74w-50s.insitu-77w-52s.sql
