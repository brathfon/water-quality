...
mysql -v -u $user -p$pw $db < ../xfer/insert-data-sessions-1-125w-1-100s.0.sql
mysql -v -u $user -p$pw $db < ../xfer/update-nutrient-data.20230807.1.nutrient-122w-97s.insitu-125w-100s.sql
exit
