...
mysql -v -u $user -p$pw $db < ../xfer/insert-data-sessions-1-70w-1-45s.1.sql
mysql -v -u $user -p$pw $db < ../xfer/update-nutrient-data.20200527.0.nutrient-69w-45s.insitu-70w-45s.sql
