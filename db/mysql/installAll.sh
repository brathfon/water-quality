...
mysql -v -u $user -p$pw $db < ../xfer/insert-data-sessions-1-126w-1-101s.0.sql
mysql -v -u $user -p$pw $db < ../xfer/update-nutrient-data.20230918.0.nutrient-125w-100s.insitu-126w-101s.sql
exit
