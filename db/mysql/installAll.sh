...
mysql -v -u $user -p$pw $db < ../xfer/insert-data-sessions-28-44-1-19.1.sql
mysql -v -u $user -p$pw $db < ../xfer/update-nutrient-data.20180816.1.sessions-thru-39w-15s.insitu-w44-s19.sql
exit
