...
mysql -v -u $user -p$pw $db < ../xfer/insert-data-sessions-1-75w-1-50s.0.sql
mysql -v -u $user -p$pw $db < ../xfer/update-nutrient-data.20200902.0.nutrient-71w-46s.insitu-75w-50s.sql
