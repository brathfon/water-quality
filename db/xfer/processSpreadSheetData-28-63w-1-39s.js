...
var readSpreadSheetFiles = function (data, endConnection, callback) {
  ...
  data['sessions'] = rss.readTeamSheets(process.env.WQ_FILES + "/gdrive-downloads/data-sessions-28-63w-1-39s");
  //data['sessions'] = rss.readTeamSheets(process.env.WQ_FILES + "/gdrive-downloads/data-sessions-28-62-1-38");
