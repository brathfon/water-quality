  ...
  for (session_number in data.sessions) {
    ...
    */
    ...
    for (j = 0; j < samples.length; ++j) {
      ...
      // take care of adding in a sampling order for the legacy data.  Will assume it is in the correct order data and time wise.
      if (the_date != currentDate) {  // a new date is found
